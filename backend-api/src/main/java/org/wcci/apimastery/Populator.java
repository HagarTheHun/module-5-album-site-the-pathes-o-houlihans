...
//      Song song1 = new Song("song1", album1);
      Song song1 = new Song("sesame-street",album1,"Kids sesame-street");
      songRepository.save(song1);
//        Song song2 = new Song("song2", album1);
        Song song2 = new Song("Il Mare Calmo Della Sera", album1,"Mare Della");
        songRepository.save(song2);
//        Song song3 = new Song("song3",album3);
        Song song3 = new Song("Sigur cos valtari",album3,"Sigur cos");
        songRepository.save(song3);
//        Song song4 = new Song("song4",album4);
        Song song4 = new Song("liminal sleep",album4,"Sleeping beauty");
        songRepository.save(song4);
//        Song song5 = new Song("song5",album3);
        Song song5 = new Song("anything",album3,"Numbers song");
        songRepository.save(song5);
//        Song song6 = new Song("song6",album6);
        Song song6 = new Song("foundations",album6, "alphabet song");
